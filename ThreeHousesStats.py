...
def growth(character = [], name = ""):
    #To calculate each stat after 30 levels, we take the BASE stat, which is their starting value, then multiply it by the GROWTH stat. Since the Growth stats are listed as a percent and we are calculating the final value after the character levels up 30 times, we multiply the growth stat by 30/100 or 0.3
